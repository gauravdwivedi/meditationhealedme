 ...
 * Use the {@link relax#newInstance} factory method to
...
public class relax extends Fragment {
    ...
    private long timeleftinmiliseconds =1800000; //30 min 00 sec
     ...
     * @return A new instance of fragment relax.
     */
    // TODO: Rename and change types and number of parameters
    public static relax newInstance() {
        relax fragment = new relax();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        timertext =view.findViewById(R.id.txtfragment3);
        btnPlay= view.findViewById(R.id.btnplay3);
        btnStop=view.findViewById(R.id.btnstop3);
        updateTimer();
  ...
  private void playSong() {
      ...
      if(mediaPlayer.isPlaying()){
          ...
          mediaPlayer =MediaPlayer.create(getContext(),R.raw.min30music);
          mediaPlayer.start();
    ...
    public void stopTimer() {
        ...
        timeleftinmiliseconds=1800000; //30 min 00 sec
